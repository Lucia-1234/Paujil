...
public class AsignacionServicio { // Clase de servicio para gestionar asignaciones.
    ...
    // Permite al administrador aprobar o devolver una asignación en revisión.
    public boolean revisarAsignacion(int idAsignacion, String observacionesAdmin, boolean aprobado) {
        return dao.revisarAsignacion(idAsignacion, observacionesAdmin, aprobado);
    }
