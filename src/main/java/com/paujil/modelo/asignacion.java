...
public class asignacion { // Clase modelo para la entidad Asignación.
    ...
    private String nombreLote; // Campo leído vía JOIN desde lotes.
    ...
    public String getNombreLote() { return nombreLote; } // Getter nombreLote.
    public void setNombreLote(String nombreLote) { this.nombreLote = nombreLote; } // Setter.
