...
 *
 * NOTA: Las funciones fechaNoEsAnteriorAHoy y fechaFinNoEsAnteriorAInicio
 * fueron eliminadas de este archivo. Están definidas exclusivamente en
 * validaciones-cultivos.js para evitar la doble declaración que causaba
 * comportamiento impredecible según el orden de carga.
 */
