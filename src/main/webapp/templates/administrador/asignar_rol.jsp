    ...
    <main class="role-manager">
        ...
        <section class="role-manager__content">
            <ul class="request-list">
                ...
                %>
                        <li class="request-item" id="user-<%= u.getIdUsuario() %>">
                            ...
                            <div class="request-item__actions">
                                <button type="button" class="btn btn--accept" onclick="gestionarUsuario(<%= u.getIdUsuario() %>, 'aceptar')">Aceptar</button>
                                <button type="button" class="btn btn--deny" onclick="gestionarUsuario(<%= u.getIdUsuario() %>, 'denegar')">Denegar</button>
                            </div>
                        </li>
                <%
                        } 
                ...
                %>
                        <li class="no-data">No hay usuarios pendientes.</li>
                <% } %>
            </ul>
        </section>
    </main>
